    ...
    <motion.div animate={{x:0}} initial={{x:'100vw'}} transition={{ type:'spring', delay:0.3}}
     className='grid grid-cols-1  md:grid-cols-1 lg:grid-cols-2'>
      <div className='text-sky-300'>
        ...
        <div>
          <h1 className='text-3xl ml-12 mr-2 mt-10 text-blue-600'>Take Your Brands Eventful story In To</h1>
        ...
        <div className='text-xl mt-4 ml-10 '>
          ...
          className='text-white rounded-full ml-2 px-8 py-2 bg-blue-500 font-bold 2xl:mt-8 2xl:px-12 2xl:py-4' >
