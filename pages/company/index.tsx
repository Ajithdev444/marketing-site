...
const index = () => {
  return (
    <>
      ...
      <div>
                <h1 className="ml-12 mt-32 mb-8 font-bold text-5xl lg:ml-56 text-blue-400 ">Company</h1>
                <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="lg:ml-10">
                  <Image className="mb-20 md:w-full" src={company} alt='dm' width={600} height={600}/>
                </div>
                <div>
